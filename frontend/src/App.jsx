      ...
      <header className="header glassmorphism">
        <Link to="/" onClick={handleLogoClick} style={{ textDecoration: 'none', color: '#fff', display: 'flex', alignItems: 'center' }}>
          <div className="header-brand" style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <span className="premium-badge" style={{ background: 'rgba(0, 224, 161, 0.1)', color: '#00e0a1', border: '1px solid rgba(0, 224, 161, 0.2)', marginLeft: '0.5rem', padding: '0.2rem 0.5rem' }}>v2.24.2 (Canex Customer Ref Parsing Fix)</span>
          </div>
        </Link>
