    ...
    <div className={`app-wrapper ${lang === 'en' ? 'ltr-layout' : ''}`}>
      ...
      <header className="header glassmorphism">
        <div className="header-brand">
          ...
          <span className="premium-badge" style={{ background: 'rgba(0, 224, 161, 0.1)', color: '#00e0a1', border: '1px solid rgba(0, 224, 161, 0.2)', marginLeft: '0.5rem', padding: '0.2rem 0.5rem' }}>v1.4.0</span>
        </div>
